...
public class MessageServiceLocator extends org.apache.axis.client.Service implements model.MessageService {
    ...
    private java.lang.String Message_address = "http://localhost:8080/IntAppServer/services/Message";
    ...
    public model.Message getMessage() throws javax.xml.rpc.ServiceException {
    ...
    public model.Message getMessage(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            model.MessageSoapBindingStub _stub = new model.MessageSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (model.Message.class.isAssignableFrom(serviceEndpointInterface)) {
                model.MessageSoapBindingStub _stub = new model.MessageSoapBindingStub(new java.net.URL(Message_address), this);
                _stub.setPortName(getMessageWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://model", "MessageService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://model", "Message"));
        }
