...
public class FriendServiceLocator extends org.apache.axis.client.Service implements model.FriendService {
    ...
    private java.lang.String Friend_address = "http://localhost:8080/IntAppServer/services/Friend";
    ...
    public model.Friend getFriend(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            model.FriendSoapBindingStub _stub = new model.FriendSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (model.Friend.class.isAssignableFrom(serviceEndpointInterface)) {
                model.FriendSoapBindingStub _stub = new model.FriendSoapBindingStub(new java.net.URL(Friend_address), this);
                _stub.setPortName(getFriendWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://model", "FriendService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://model", "Friend"));
        }
